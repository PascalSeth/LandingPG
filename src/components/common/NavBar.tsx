...
function NavBar() {
  ...
  return (
    <div className="md:sticky md:top-0 bg-white z-[999] left-0 right-0  md:shadow-none w-full ">
      {/* DESKTOP */}
      <div className=" hidden lg:block animate-in fade-in zoom-in w-full p-4 ">
